...
const MENU_MUSIC: AudioStream = preload("res://assets/audio/menu/menu.mp3")
const HOVER_SOUND: AudioStream = preload("res://assets/audio/ui/select_006.ogg")
const CLICK_SOUND: AudioStream = preload("res://assets/audio/ui/confirmation_002.ogg")
...
func _configure_styles() -> void:
	...
	for button in [start_button, option_button, quit_button, back_button]:
...
func _show_main_menu() -> void:
	...
	_set_hint_text("tips: Shift through the city.")
...
func _on_start_pressed() -> void:
	_play_click_sfx()
	_set_hint_text("Signal locked. Entering the shift test room...")
