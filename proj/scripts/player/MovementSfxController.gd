...
const WALK_SOUND: AudioStream = preload("res://assets/audio/player/scroll_002.ogg")
const RUN_SOUND: AudioStream = preload("res://assets/audio/player/scroll_005.ogg")
const JUMP_SOUND: AudioStream = preload("res://assets/audio/player/maximize_002.ogg")
const LAND_SOUND: AudioStream = preload("res://assets/audio/player/drop_002.ogg")
